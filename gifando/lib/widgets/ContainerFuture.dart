...
class ContainerFuture extends StatefulWidget {
  ...
  final bool grid;
  final bool trending;
  const ContainerFuture(
      {Key key, this.categoria, this.grid, this.trending = false})
      : super(key: key);
...
class _ContainerFutureState extends State<ContainerFuture> {
    ...
    return Container(
      ...
      child: FutureBuilder(
          future: widget.trending == false
              ? gifModel.getGifs(widget.categoria, _offSet,
                  limit: widget.grid == true ? 23 : 14)
        ...
        ? Swiper(
            ...
            itemBuilder: (context, index) {
              return CardTrendingItem(
                url: snapshot.data["data"][index]["images"]["480w_still"]
                    ["url"],
                index: index,
                snapshot: snapshot,
              );
  ...
  Widget createGifTable(BuildContext context, AsyncSnapshot snapshot) {
    ...
    return Padding(
      padding:
          EdgeInsets.only(bottom: 2, right: width * 0.015, left: width * 0.025),
      child: Column(
        children: <Widget>[
          Expanded(
            child: SizedBox(
              ...
              child: GridView.builder(
                  padding:
                      EdgeInsets.only(right: width * 0.03, top: width * 0.03),
                      ...
                      return Container(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              // ),
                              color:
                                  Colors.transparent, //Colors.limeAccent[400],
